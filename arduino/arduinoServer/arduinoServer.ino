...
const int STEPPER1_MAX_SPEED = 400.0;
const int STEPPER1_SPEED = 400.0;
const int STEPPER1_ACCELERATION = 400.0;
// Driver 2 config
const int DRIVER2_ENA = 12;
const int DRIVER2_DIR = 11;
const int DRIVER2_PUL = 10;
const int STEPPER2_MAX_SPEED = 400.0;
const int STEPPER2_SPEED = 400.0;
...
int moveCommand() {
  ...
  if(stepperExists)
  {
    moveStepper(stepper, steps);
    sendResponse("MOVE:" + command->params[1] + ":" + command->params[2]);
    rc = 0;
  }
  else
  {
